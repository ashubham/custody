...
import { controlFlow as flow } from '../controlFlow';
...
function makeAsyncTestFn(fn) {
    ...
    let ret = /** @type {function(this: mocha.Context)}*/ (function (done) {
        ...
        let mochaCallback = runnable.callback;
        ...
        flow.execute(function controlFlowExecute() {
            return flow.promise(function (fulfill, reject) {
...
function ignore(predicateFn) {
    let describe = wrap(exports.xdescribe, exports.describe) as any;
    describe.only = wrap(exports.xdescribe, exports.describe.only);

    let it = wrap(exports.xit, exports.it) as any;
